...
# NSE holidays for 2026 (weekday closures only — weekends handled separately)
# Source: NSE circular CMTR71775 / Zerodha holiday calendar
# Aug 15 (Independence Day) falls on Saturday — no weekday closure
# Nov 8 (Diwali Laxmi Pujan) falls on Sunday — Muhurat trading session only, no weekday closure
NSE_HOLIDAYS_2026 = [
    ...
    date(2026, 9, 16),   # Milad-Ul-Nabi (Id-E-Milad)
    date(2026, 10, 2),   # Mahatma Gandhi Jayanti
    date(2026, 11, 11),  # Diwali (Balipratipada)
